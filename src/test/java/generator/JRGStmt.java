...
public class JRGStmt {
  ...
  public Arbitrary<VariableDeclarationExpr> genVarDecl(Map<String, String> ctx)
    ...
    Log.showMessage(Log.Severity.MSG_XDEBUG, "genVarDeclaration::inicio");
    ...
    Log.showMessage(Log.Severity.MSG_XDEBUG, "genVarDeclaration::fim");
  ...
  public Arbitrary<Statement> genStatement(Map<String, String> ctx) {
    Log.showMessage(Log.Severity.MSG_XDEBUG, "genStatement::inicio");
    ...
    Log.showMessage(Log.Severity.MSG_XDEBUG, "genStatement::fim");
  ...
  public Arbitrary<NodeList<Statement>> genStatementList(
    ...
    Log.showMessage(Log.Severity.MSG_XDEBUG, "genStatementList::inicio");
    ...
    Log.showMessage(Log.Severity.MSG_XDEBUG, "genStatementList::fim");
  ...
  public Arbitrary<BlockStmt> genBlockStmt(Map<String, String> ctx) {
    Log.showMessage(Log.Severity.MSG_XDEBUG, "genBlockStmt::inicio");

    Arbitrary<NodeList<Statement>> l = genStatementList(ctx);

    BlockStmt b = new BlockStmt(l.sample());

    Log.showMessage(Log.Severity.MSG_XDEBUG, "genBlockStmt::fim");
  ...
  public Arbitrary<VariableDeclarationExpr> genVarDeclAssign(
    ...
    throws ClassNotFoundException {
    Log.showMessage(Log.Severity.MSG_XDEBUG, "genVarDeclarator::inicio");
    Arbitrary<PrimitiveType> pt = mBase
      .primitiveTypes()
      .map(t -> new PrimitiveType(t));
    ...
    Log.showMessage(Log.Severity.MSG_XDEBUG, "genVarDeclarator::fim");
  ...
  //   Log.showMessage(Log.Severity.MSG_XDEBUG, "genIfStmt::inicio");
  ...
  //   Log.showMessage(Log.Severity.MSG_XDEBUG, "genIfStmt::fim");
  ...
  public Arbitrary<WhileStmt> genWhileStmt(Map<String, String> ctx) {
    Log.showMessage(Log.Severity.MSG_XDEBUG, "genWhileStmt::inicio");
    ...
    Log.showMessage(Log.Severity.MSG_XDEBUG, "genWhileStmt::fim");
    return e.map(
      exp ->
        new WhileStmt(
  ...
  //   throws ClassNotFoundException {
  //   Log.showMessage(Log.Severity.MSG_XDEBUG, "genForStmt::inicio");
  ...
  //   Log.showMessage(Log.Severity.MSG_XDEBUG, "genForStmt::fim");
  //   return e.map(
